...
XP2AIOM makes migrating your custom layouts, Fusion widget presets, and catalogs from Nuvio / Xperience into Stremio's AIOMetadata addon seamless and effortless.
...
- **🔗 Manifest & Preset Importer**: Full support for importing via direct Stremio `manifest.json` URLs, drag-and-drop file upload (`fusion-widgets.json`), or raw JSON paste.
